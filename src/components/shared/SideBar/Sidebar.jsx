                ...
                <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6 flex flex-col gap-3">
                    ...
                    <div className="">
                        ...
                        <ul className='flex flex-col gap-1.5'>
                            ...
                            <li><Link onClick={() => handleMenuClick('menu3')} className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover ${activeMenu === 'menu3' ? "bg-menuHover" : ""}`} href=""><RiPagesLine className='text-xl' />pages <MdKeyboardArrowDown className={`ml-auto text-xl ${activeMenu === 'menu3' ? "rotate-180" : ""}`} /></Link></li>
                    ...
                    <div className="">
                        ...
                        <ul className='flex flex-col gap-1.5'>
                            <li><Link className='className="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover' href=""><IoMailOutline className='text-xl' />Messages</Link></li>
                            <li><Link className='className="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover' href=""><CiInboxIn className='text-xl' />Inbox</Link></li>
                            <li><Link className='className="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover' href=""><LiaFileInvoiceDollarSolid className='text-xl' />invoice</Link></li>
                        </ul>
                    </div>
                    {/* others Group  */}
                    <div className="">
                        ...
                        <ul className='flex flex-col gap-1.5'>
                            <li><Link className='className="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover' href=""><GrPieChart className='text-xl' />Charts</Link></li>
                            <li><Link onClick={() => handleMenuClick('menu4')} className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover ${activeMenu === 'menu4' ? "bg-menuHover" : ""}`} href=""><TbCircuitCellPlus className='text-xl' />UI Elements <MdKeyboardArrowDown className={`ml-auto text-xl ${activeMenu === 'menu4' ? "rotate-180" : ""}`} /></Link></li>
                            ...
                            <li><Link onClick={() => handleMenuClick('menu5')} className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white duration-300 ease-in-out hover:bg-menuHover ${activeMenu === 'menu5' ? "bg-menuHover" : ""}`} href=""><LuLogIn className='text-xl' />Authentication <MdKeyboardArrowDown className={`ml-auto text-xl ${activeMenu === 'menu5' ? "rotate-180" : ""}`} /></Link></li>
