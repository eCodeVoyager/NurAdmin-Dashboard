...
const Notifiy = () => {
    ...
    return (
        <div onClick={handleClick} className="select-none absolute top-8 -right-28 lg:-right-24 mt-2.5 flex h-96 w-72 flex-col rounded-sm border border-stroke bg-white shadow-md md:right-0 md:w-80">
            <div className="px-4 py-3">
                <h5 className="text-sm font-medium text-[0.875rem] text-secondary">Notification</h5>
            </div>

            <ul className="flex h-auto flex-col overflow-y-auto">
                <li>
                    <a className="flex flex-col gap-3 border-t border-stroke px-4 py-3 hover:bg-gray-100" href="#">
                ...
                <li>
                    <a className="flex flex-col gap-2 border-t border-stroke px-4 py-3 hover:bg-gray-100" href="#">
                        <p className="text-sm text-secondary">
