...
const Message = () => {
    ...
    return (
        <div onClick={handleClick} class="select-none absolute top-8 -right-28 mt-2.5 flex h-96 w-72 flex-col rounded-sm border border-stroke bg-white shadow-md md:right-0 md:w-80">
            <div class="px-4 py-3">
