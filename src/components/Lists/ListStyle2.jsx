...
const ListStyle2 = () => {
  return (
    <div className="min-w-[370px] max-w-max rounded-md border border-stroke py-1">
    <ul className="flex flex-col">
      <li className="flex items-center gap-2 border-b border-stroke px-5 py-3 last:border-b-0">
      ...
      <li className="flex items-center gap-2.5 border-b border-stroke px-5 py-3 last:border-b-0">
        <span className="text-primary">
          <svg className="fill-current" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1890_16515)">
              <path d="M10.8672 0.949463C5.64844 0.949463 1.42969 5.16821 1.42969 10.387C1.42969 15.6057 5.64844 19.8557 10.8672 19.8557C16.0859 19.8557 20.3359 15.6057 20.3359 10.387C20.3359 5.16821 16.0859 0.949463 10.8672 0.949463ZM10.8672 18.4495C6.42969 18.4495 2.83594 14.8245 2.83594 10.387C2.83594 5.94946 6.42969 2.35571 10.8672 2.35571C15.3047 2.35571 18.9297 5.98071 18.9297 10.4182C18.9297 14.8245 15.3047 18.4495 10.8672 18.4495Z" fill=""></path>
