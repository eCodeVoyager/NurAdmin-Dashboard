...
const NotificationStyle2 = () => {
    return (
        <div class="max-w-[490px] rounded-lg border border-[#F5C5BB] bg-[#FCEDEA] py-4 pl-4 pr-5 shadow-md">
            <div class="flex items-center justify-between">
                <div class="flex flex-grow items-center gap-5">
                    <div class="flex h-16 w-full max-w-16 items-center justify-center rounded-md bg-[#EA4E2C]">
