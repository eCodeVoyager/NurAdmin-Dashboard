    ...
    return (
        <div>
            ...
            <div className="relative z-20 bg-white">
                ...
                <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-primary active:border-primary" >
                    <option value="" className="text-body">USA</option>
                    <option value="" className="text-body">UK</option>
                    <option value="" className="text-body">Canada</option>
                </select>
