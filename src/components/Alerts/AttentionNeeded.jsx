...
const AttentionNeeded = () => {
  return (
    <div className="flex w-full border-l-8 border-[#FFA70B] bg-[#FFA70B] bg-opacity-[15%] px-7 py-8 shadow-md md:p-9">
    <div className="mr-5 flex h-9 w-9 items-center justify-center rounded-lg bg-[#FFDB9C] bg-opacity-30">
