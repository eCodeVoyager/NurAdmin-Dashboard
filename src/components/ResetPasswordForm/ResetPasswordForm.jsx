...
const ResetPasswordForm = () => {
  return (
    ...
    <div class="w-full p-4 sm:p-12 xl:p-16">
      <h2 class="mb-3 text-2xl font-bold text-black  md:text-[32px]">
        Reset Password
      </h2>
      <p class="mb-7 font-medium text-secondary">
      ...
      <form>
        <div class="mb-6">
          ...
          <div class="relative">
            <input type="email" placeholder="Enter your email" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none "/>
