...
const Modal2 = ({closeModalTwo}) => {
    return (
        <div className="fixed left-0 top-0 z-[999999] flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5">
            <div className="w-full max-w-xl rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:px-17.5 md:py-15">
                ...
                <h3 className="mt-5.5 pb-2 text-xl font-bold text-black md:text-2xl">
                ...
                <div className="-mx-3 flex flex-wrap gap-y-4">
                    <div className="w-full px-3 md:w-1/2">
                        <button onClick={closeModalTwo} className="block w-full rounded border border-stroke bg-gray p-3 text-center font-medium text-black transition hover:border-meta-1 hover:bg-meta-1 hover:text-white hover:bg-red-600">
                            Cancel
                        </button>
                    </div>
                    <div className="w-full px-3 md:w-1/2">
                        <button className="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90 bg-red-600">
                            Deactivate
                        </button>
                    </div>
                </div>
