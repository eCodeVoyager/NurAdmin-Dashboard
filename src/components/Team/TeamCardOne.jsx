...
const TeamCardOne = ({data}) => {
    return (
        <div>
            <div className="relative z-[99] mx-auto h-[170px] w-full max-w-[170px] rounded-full">
                <img className="rounded-full" src={data.image} alt="team" />
