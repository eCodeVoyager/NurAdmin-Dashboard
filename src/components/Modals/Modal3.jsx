...
const Modal3 = ({ closeModalThree }) => {
    return (
        <div className="fixed left-0 top-0 z-[999999] flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5">
            <div className="relative w-full max-w-xl rounded-lg bg-primary px-8 py-12 text-center md:px-16 md:py-16">
                ...
                <span className="mx-auto mb-6 inline-block h-1 w-20 rounded bg-primary"></span>
                <p className="mb-7 font-medium text-white">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry
                    Lorem Ipsum been.
                </p>
                <a href="#" className="inline-block rounded border border-white px-12 py-3 text-center font-medium text-white transition hover:bg-white hover:text-primary">
                    Know More
                </a>
                <button onClick={closeModalThree} className="absolute right-6 top-6 flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white hover:text-primary">
