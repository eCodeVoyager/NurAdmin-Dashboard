    ...
    return (
        <div class="flex flex-col">
            <div className="w-full max-w-[360px] rounded-md border border-stroke py-2">
                <div class="flex items-center justify-between p-4 hover:bg-[#F9FAFB]">
                    <div class="flex items-center">
                        <div class="mr-4 h-[50px] w-full max-w-[50px] overflow-hidden rounded-full">
                            <img src={useImg} alt="user" class="rounded-full object-cover object-center" />
                        </div>
                        <div>
                            <h4 class="text-base font-medium text-black">
                                Devid Wilium
                            </h4>
                            <p class="text-sm text-secondary whitespace-nowrap">Digital marketer</p>
                        </div>
                    </div>
                    <div>
                        <div class="relative">
                            <button onFocus={() => setOpen(!open)}>
                                ...
                                <div onBlur={() => setOpen(!open)} class="absolute right-0 top-full z-40 w-36 space-y-1 rounded bg-white p-2 shadow-md">
                                    <button class="w-full rounded px-3 py-1.5 text-left text-sm hover:bg-gray-200">
                                        Edit
                                    </button>
                                    <button class="w-full rounded px-3 py-1.5 text-left text-sm hover:bg-gray-200">
                                        Delete
