        ...
        <div>
            <div className="mb-5 flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="relative z-20 inline-block rounded">
                    <select className="relative z-20 inline-flex appearance-none rounded border border-stroke bg-transparent py-[5px] pl-3 pr-8 text-sm font-medium outline-none">
                        <option value="" className="">Last 7 days</option>
                        <option value="" className="">Last 15 days</option>
                    </select>
            ...
            <div className="mb-3 flex flex-wrap gap-6">
                <div>
                    <p className="mb-1.5 text-sm font-medium text-secondary">Invested Value</p>
                    <div className="flex items-center gap-2">
                        <p className="font-medium text-black">$1,279.95</p>
                ...
                <div>
                    <p className="mb-1.5 text-sm font-medium text-secondary">Total Returns</p>
                    <div className="flex items-center gap-2">
                        <p className="font-medium text-black">$22,543.87</p>
                        <p className="flex items-center gap-1 font-medium text-green-500">
                            10.14%
