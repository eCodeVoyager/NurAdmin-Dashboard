        ...
        <>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                  ...
                  <span class="inline-block rounded-md bg-primary px-1.5 py-0.5 text-xs font-medium text-white">10%</span>
                </div>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <span class="inline-block rounded-md bg-secondary px-1.5 py-0.5 text-xs font-medium text-white">20%</span>
                </div>

                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    <span class="block h-4 w-4 rounded-full border-4 border-blue-400"></span>
                    <span class="font-medium text-black-2">Desktop</span>
                  </div>

                  <span class="inline-block rounded-md bg-blue-400 px-1.5 py-0.5 text-xs font-medium text-white">70%</span>
                </div>
              </div>
        </>
    )
